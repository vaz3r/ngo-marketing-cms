<template>
  <section>
    <div id="example-1" class="cell example example1">
      ...
      <div id="success-box" class="success" style="display: none;">
        <div class="icon">
          <svg
            width="84px"
            height="84px"
